...
class _HelloscreenState extends State<Helloscreen> {
  final List<Map<String, dynamic>> items = [
    {"name": "Politics", "name_tr": "Politika", "icon": Icons.account_balance},
    {"name": "Business", "name_tr": "İş", "icon": Icons.attach_money},
    {"name": "Sports", "name_tr": "Spor", "icon": Icons.sports_soccer},
    {"name": "Technology", "name_tr": "Teknoloji", "icon": Icons.devices},
    {"name": "Health", "name_tr": "Sağlık", "icon": Icons.local_hospital},
    {"name": "Science", "name_tr": "Bilim", "icon": Icons.science},
    {"name": "Entertainment", "name_tr": "Eğlence", "icon": Icons.movie},
    {"name": "Education", "name_tr": "Eğitim", "icon": Icons.school},
    {"name": "Security", "name_tr": "Güvenlik", "icon": Icons.security},
    {"name": "Culture", "name_tr": "Kültür", "icon": Icons.people},
    {"name": "Environment", "name_tr": "Çevre", "icon": Icons.eco},
    {"name": "Travel", "name_tr": "Seyahat", "icon": Icons.flight},
  ];
                ...
                DropdownButton<String>(
                  ...
                  onChanged: (String? newValue) {
                    setState(() {
                      ...
                      myLocalController.changeLanguage(
                        newValue == "English" ? "en_US" : "tr_TR",
                      );
                      Pref.language = newValue == "English" ? "en_US" : "tr_TR";
                      Get.updateLocale(
                        Locale(newValue == "English" ? "en_US" : "tr_TR"),
                      );
                    });
                  },
                  items:
